# Obelisk Freighter blueprint requirements

# Display name for the dropdown menu
display_name = "Obelisk Freighter"

# Blueprint ownership status
owned_status = "Unowned"

# Component quantities required for Obelisk construction
obelisk_requirements = {
...
obelisk_pi_materials = {
    "Self-Harmonizing Power Core": 35,
    ...
    "Reinforced Carbon Fiber": 37660,
    "Cogni-Emotive Neurolink Enhancer": 640,
    "Stress-Responding Neurolink Stabilizer": 16,
    "Chiral Structures": 5000,
    "Water": 5000
}

# Ship specifications and attributes
obelisk_specifications = {
